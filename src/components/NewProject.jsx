...
const NewProject = ({onAdd, onCancel}) => {
    ...
    function handleSave(){
        ...
        if(enteredTitle.trim() === '' || enteredDecription.trim() === '' || enteredDueDate.trim() === ''){
            modal.current.open()
            return
        }
  ...
  return (
    ...
    <Modal ref={modal} buttonCaption={'Okay'}>
      ...
      <menu className='flex items-center justify-end gap-4 my-4'>
        <li><button className='text-stone-800 hover:text-stone950' onClick={onCancel}>Cancel</button></li>
